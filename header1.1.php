...
if (isset($_SESSION['loggedIn']) && ($_SESSION['username']=='admin'))
{
    ...
    <div class="pos-f-t">
        <div class="collapse secondary-nav-container container" id="nav-collapse1">
            <div class="row">
                <ul class="list-group adminList">
                    ...
                    <li class="col-xs-3 list-group-item">
                        <a class="hvr-float-shadow" href="myProfile.php"><h5><i class="far fa-id-badge fa-fw"></i>MyAccount</h5><span class="sr-only">(current)</span></a>
                    </li>
                    <li class="col-xs-3 list-group-item">
                        <a class="hvr-float-shadow" href="myProfile.php"><h5><i class="fas fa-users"></i> All Users</h5><span class="sr-only">(current)</span></a>
                    </li>
                    <li class="col-xs-3 list-group-item logOut">
                        <a class="hvr-float-shadow" href="logout.php"><h5><i class="far fa-user fa-fw"></i>LogOut(<?php echo $_SESSION['username']?>)</h5><span class="sr-only">(current)</span></a>
                    </li>
                </ul>
            </div>
        </div>
        <nav class="navbar navbar-dark">
            <button class="navbar-toggler leftNavButton" type="button" data-toggle="collapse" href="#nav-collapse1" aria-expanded="false" aria-controls="nav-collapse1">
                <span <i class="far fa-caret-square-up"></i></span>
            </button><span><p class="navbar-text navbar-right">Hello <b class="sessName"><?php echo $_SESSION['username'] ?></b></p></span>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <form class="form-inline my-5 my-lg-3" action="searchResults.php?searchName=<?php echo $_GET['search']; ?>">
            ...
            <button class="btn btn-sm searchBar" type="submit">Search</button>
        </form>
        <ul class="navbar-nav mr-5 mt-5 mt-lg-2 basketMar">
            <li class="mr-1 libasket">
...
<?php }
...
else if (isset($_SESSION['loggedIn']) && ($_SESSION['username']!='admin')) {
    {
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <form class="form-inline my-5 my-lg-3" action="searchResults.php?searchName=<?php echo $_GET['search']; ?>">
                <input class="form-control btn-md" name="search" id="searchBar" type="search" placeholder="What are you looking for?" aria-label="Search">
                <button class="btn btn-sm searchBar" type="submit">Search</button>
            </form>
...
<?php }
    ...
    <div class="pos-f-t">
        <div class="collapse secondary-nav-container container" id="nav-collapse1">
            <div class="row">
                <form action="register.php" method="post">
                    <div class="col-auto">
                        <button type="submit" class="btn btn-info mb-2 fas fa-user-plus"> Register Here</button>
                    </div>
                </form>
                <form action="login.php" method="post">
                    <div class="col-auto">
                        <button type="submit" class="btn btn-info mb-2 fas fa-sign-in-alt"> Login Here</button>
                    </div>
                </form>
            </div>
        </div>
        <nav class="navbar navbar-dark">
            <button class="navbar-toggler leftNavButton" type="button" data-toggle="collapse" href="#nav-collapse1" aria-expanded="false" aria-controls="nav-collapse1">
                <span <i class="far fa-caret-square-up"></i></span>
            </button><span><p class="navbar-text navbar-right">Hello <b class="sessName">Login / Register</b></p></span>
            <div id="myPageContent" class="container-fluid">
                <section id="home">
                    <div id="textSlider" class="row">
                        <div class="col-xs-12 col-sm-12 col-md-2 col-lg-4 iamCol">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <ul class="navbar-nav mr-5 mt-5 mt-lg-2 basketMar">
            <li class="mr-1 libasket">
                <a class="hvr-float-shadow" href="#"><h5><i class="fas fa-shopping-cart"></i>Basket</h5></a>
            </li>
        </ul>
    </nav>
<?php } ?>
<?php
$sqlCat = "SELECT * FROM category LIMIT 6";
$resultCat = mysqli_query($connection, $sqlCat);
$nCat = mysqli_num_rows($resultCat);
if($nCat> 0) {
    ?>
    ...
    <nav class="navbar navbar-default navbar-static-top">
        <div class="container-cat">
            ...
            for($i=0; $i<$nCat; $i++)
            {
                ...
                $category = $rowCat['cat_title'];
                ?>
                <a class="hvr-shadow-radial cat grow" href="view_products.php?category=<?php echo$category?>"><?php echo $category?></a>
            <?php } ?>
        </div>
    </nav>
