...
while($row = mysqli_fetch_array($result))
{
    ...
    $sub_array[] = '<button type="button" name="delete" class="btn btn-danger btn-xs delete" data-id3="'.$row["cat_id"].'" data-column="cat_id"><i class="fas fa-trash-alt"></i> Delete</button>';
    $sub_array[] = '<button type="button" name="update" class="btn btn-warning btn-xs update" data-id3="'.$row["cat_id"].'" data-column="cat_id"><i class="far fa-edit"></i> Update</button>';
    $data[] = $sub_array;
}
